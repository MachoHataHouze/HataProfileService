...
builder.Services.AddHttpClient<IProfileService, ProfileService.Services.ProfileService>(client =>
{
    client.BaseAddress = new Uri(builder.Configuration["BookingServiceUrl"]);
});
